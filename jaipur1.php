...
<head>
<meta charset="utf-8">
<title>Jaipur | The Fabric Studio</title>
<link rel="stylesheet" type="text/css" href="jaipurcss.css">
...
<body>
	<div>
		<ul>
			...
			<b>
				...
				<li style="padding: 20px 18px 20px 18px;"><a href="mumbai1.php">Mumbai</a></li>
				...
				<li style="padding: 20px 18px 20px 18px;"><a href="mumbai.html">Mumbai</a></li>
	...
	<div class="review">
		...
		global $error;
			...
			$records = mysqli_query($db1,"select * from tailorjaipur "); // fetch data from database
