...
<head>
<meta charset="utf-8">
<title>Mumbai | The Fabric Studio</title>
<link rel="stylesheet" type="text/css" href="mumbaicss.css">
...
<body>
	<div>
		<ul>
			...
			<b>
				...
				<li style="padding: 20px 0px 20px 18px;"><a href="logout.php"  onclick="myFunction1()" >Logout</a></li>
				<li style="padding: 20px 18px 20px 18px;"><a href="hyderabad1.php">Hyderabad</a></li>
				<li style="padding: 20px 18px 20px 18px;"><a href="jaipur1.php">Jaipur</a></li>
				<li style="padding: 20px 18px 20px 18px;"><a href="delhi1.php">Delhi</a></li>
				...
				<li style="padding: 20px 0px 20px 18px;"><a href="hyderabad.html">Hyderabad</a></li>
				<li style="padding: 20px 18px 20px 18px;"><a href="jaipur.html">Jaipur</a></li>
				<li style="padding: 20px 18px 20px 18px;"><a href="delhi.html">Delhi</a></li>
	...
	<div class="review">
		...
		global $error;
			...
			$records = mysqli_query($db1,"select * from tailormumbai "); // fetch data from database
		...
		<div class="row3">
			...
			<div class="column4" style="background-color:#eee;">
				...
				<p>
					...
					<a href="product_new.php" class="products" id="productsoffered">Products Offered</a>
				</p>
			</div>
